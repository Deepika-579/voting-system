...
<div class="form-group">
						<label for="email" style="color:red">Your ID</label>
						<input type="text" class="form-control" id="exampleInputEmail1" name="user_id" placeholder="Enter your Id" required>
					</div>
					...
					<div class="form-group">
						<button type="submit" class="btn btn-success btn-block" name="login" style="color:blue;font-size:40px">Enter Voting Area</button>
					</div>
