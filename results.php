...
<h3 class="text-info text-center">Result Portion</h3>
...
<table class="table table-responsive table-hover table-borderred text-center">
<tr>
<td>#</td>
...
if(isset($_POST['search_results'])){
	 ...
	 $select="select * from results_tb2 where elections_name='$elections_name'";
	 $run=$conn->query($select);
	 if($run->num_rows>0){
	 ...
	 $select1="select * from candidates_tb2 where elections_name='$elections_name'";
